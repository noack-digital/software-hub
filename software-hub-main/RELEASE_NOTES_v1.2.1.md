...
### Dependencies
- **Next.js:** `15.1.6` → `15.1.9` (gepatchte Version)
- **eslint-config-next:** `15.1.6` → `15.1.9` (für Konsistenz)

### Versionierung
- Version auf `1.2.1` erhöht
...
npm install next@15.1.9 eslint-config-next@15.1.9
