...
const embedDir = path.join(__dirname, 'src', 'app', 'admin', 'embed');
if (!fs.existsSync(embedDir)) {
  fs.mkdirSync(embedDir, { recursive: true });
  console.log(`Verzeichnis erstellt: ${embedDir}`);
}
...
// Datei schreiben
const pagePath = path.join(embedDir, 'page.tsx');
fs.writeFileSync(pagePath, pageContent);
console.log(`Datei erstellt: ${pagePath}`);

console.log('Embed-Seite wurde erfolgreich erstellt!');
