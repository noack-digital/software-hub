...
export async function GET() {
  try {
    console.log('GET /api/target-groups - Starte Abfrage');
    ...
    console.log('GET /api/target-groups - Gefunden:', targetGroups.length, 'Zielgruppen');
    ...
    return NextResponse.json(
      { error: 'Fehler beim Abrufen der Zielgruppen', details: error.message },
      { status: 500 }
    );
  }
}
